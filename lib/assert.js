...
exports.isDate = (value, message) => {
  if (toString.call(value) !== '[object Date]') throw TypeError(message);
}
...
exports.isAccountable = (value, message) => {
	...
	if (['[object String]', '[object Object]'].indexOf(type) === -1) throw TypeError(message);
}
