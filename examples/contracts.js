...
module.exports = () => {
  console.log('--- SMART CONTRACT EXAMPLES ---\n');
...
// END SETUP
              ...
              const contract = temp.createContract(compiled.contracts[0].bytecode, compiled.contracts[0].abi);
                    ...
                    contract
                      .whenStatusEquals('Ok')
                        .then(() => {
                          ...
                          temp.executeContract(contract, 'plusOne', [1], compiled.contracts[0].abi)
                            .whenStatusEquals('Ok')
                              .then((result) => {
                    console.log(1111);
